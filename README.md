...
Initially created by [Haris Mehrzad](https://github.com/xPolar) from [Spacedrive](https://github.com/spacedriveapp/linear-github-sync), now maintained by [Cal.com](https://cal.com/) and [Neat.run](https://neat.run/)
